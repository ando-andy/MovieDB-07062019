...
final class ReviewsViewModelTests: XCTestCase {
    ...
    private var navigator: ReviewsNavigatorMock!
    private var useCase: ReviewsUseCaseMock!
    
    private var input: ReviewsViewModel.Input!
    private var output: ReviewsViewModel.Output!
    ...
    override func setUp() {
        super.setUp()
        navigator = ReviewsNavigatorMock()
        useCase = ReviewsUseCaseMock()
        viewModel = ReviewsViewModel(navigator: navigator, useCase: useCase, movie: Movie())

        input = ReviewsViewModel.Input(
